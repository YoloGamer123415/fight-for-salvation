...
public class InvincibleAbility extends NormalAbility implements IAlarmListener {
	private static final float DURATION = 2.5f;

	private final String alarmName = UUID.randomUUID().toString();
	private final Alarm alarm;

	public InvincibleAbility(GameObject holder, Rarity chestRarity) {
		super("Invincibility", new Sprite("src/main/resources/usables/abilities/normal/invisibility.png"), holder, chestRarity, 15f);
